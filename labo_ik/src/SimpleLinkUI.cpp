...
SimpleLinkUI::SimpleLinkUI(gti320::Armature* _armature, gti320::Link* _link, int _id, nanogui::Widget* _parent) : armature(_armature), link(_link)
{
...
void SimpleLinkUI::onSlidersChanged()
{
...
void SimpleLinkUI::onArmatureChanged()
{
